...
export const TRANSLATIONS = {
  en: {
    ...
    tier_desc_standard: "Free • Fast • Basic Models",
    tier_desc_premium: "Paid • Smartest • Deep Analysis",
    context_hub: "Knowledge Assets",
    context_manage: "Manage / Upload",
    context_title: "Context Hub",
    context_desc: "Upload resumes, scripts, or notes for Luna to memorize.",
    ...
    no_assets: "No assets yet. Add one to give Luna context.",
    drag_drop: "Drag & drop PDF, DOCX, or TXT",
  ...
  th: {
    ...
    tier_desc_standard: "ฟรี • เร็ว • โมเดลพื้นฐาน",
    tier_desc_premium: "จ่ายเงิน • ฉลาดที่สุด • วิเคราะห์เชิงลึก",
    context_hub: "คลังข้อมูล",
    context_manage: "จัดการ / อัปโหลด",
    context_title: "คลังข้อมูลบริบท",
    context_desc: "อัปโหลดเรซูเม่ สคริปต์ หรือโน้ตเพื่อให้ลูน่าจดจำ",
    add_asset: "เพิ่มข้อมูลใหม่",
    paste_text: "วางข้อความ",
    upload_file: "อัปโหลดไฟล์",
    asset_name: "ชื่อข้อมูล",
    asset_content: "เนื้อหา",
    save_asset: "บันทึกข้อมูล",
    no_assets: "ยังไม่มีข้อมูล เพิ่มเพื่อช่วยให้ลูน่าเข้าใจบริบท",
    drag_drop: "ลากและวาง PDF, DOCX หรือ TXT",
